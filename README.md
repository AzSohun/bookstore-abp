...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 02402826-62f0-4568-b318-4a40f20d2894
```

> `02402826-62f0-4568-b318-4a40f20d2894` is the password of the certificate, you can change it to any password you want.
